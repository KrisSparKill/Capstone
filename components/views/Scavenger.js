  ...
  <main>
    <div class="${store.Global.selectedBrand} secondaryBkgrnd">
      <div id="scavengerHunt">
        ...
        <h3>Pre-Cruise</h3>
        <p>
          Keep that camera handy, and immortalize those moments, making the trip
          even more grand before it officially beings
        </p>
        <p id="box1">
        ...
        <p id="box2">
          <input type="checkbox" class="box" />Wings or wheels in motion's deal,
          grab that shot, your travel's seal.
        </p>
        <p id="box3">
          <input type="checkbox" class="box" />Passport's face, journey's grace,
          frame it tight, no space to chase.
        </p>
        <p id="box4">
        ...
        <p id="box10">
          <input type="checkbox" class="box" />On the gangway, step the sway, a
          moment in steel, it's your get-away.
        </p>
        <p id="box11">
        ...
        <p id="box13">
          <input type="checkbox" class="box" />Lunch on board, a feast to score,
          take a shot before you explore.
        </p>
        <p id="box14">
        ...
        <p id="box15">
          <input type="checkbox" class="box" />Steward's greet, with a smile so
          grand, a picture with them, isn't it grand!
        </p>
        <p id="box16">
          <input type="checkbox" class="box" />Dining guest, your table’s nest,
          find and capture where you’ll rest.
        </p>
        <p id="box17">
        ...
        <p id="box21">
          <input type="checkbox" class="box" />Ship’s path on a glowing screen,
          chart your travels, voyage unseen.
        </p>
        <p id="box22">
        ...
        <p id="box23">
          <input type="checkbox" class="box" />Balcony tales out in the breeze,
          on the deck – a shot with ease.
        </p>
        <p id="box24">
        ...
        <p id="box26">
          <input type="checkbox" class="box" />Knock, knock, room service here,
          a picture to commemorate, year on year.
        </p>
        <p id="box27">
        ...
        <p id="box28">
          <input type="checkbox" class="box" />Delight in sweets, a meal’s last
          wave, snap the dessert that you crave.
        </p>
        <p id="box29">
        ...
        <p id="box31">
          <input type="checkbox" class="box" />Waterslide antics, fun unfurled,
          capture the rush, down the twirled.
        </p>
        <p id="box32">
        ...
        <p id="box35">
          <input type="checkbox" class="box" />Logo or name, ship’s proud badge,
          snap its mark, on your voyage.
        </p>
        <p id="box36">
        ...
        <p id="box40">
          <input type="checkbox" class="box" />Cruise director’s smile, program
          in hand, snap away for a memory grand.
        </p>
        <p id="box41">
          <input type="checkbox" class="box" />Captain’s helm, steady and sure,
          with them, a photo to endure.
        </p>
        <p id="box42">
          <input type="checkbox" class="box" />Seuss on the loose, find the cat,
          Dr. Seuss character – click, that’s that!
        </p>
        <h3>Port Stops</h3>
        <p>
        ...
        <p id="box43">
          <input type="checkbox" class="box" />With Nassau’s landmark, standing
          proud, snap that sign amidst the crowd.
        </p>
        <p id="box44">
        ...
        <p id="box45">
          <input type="checkbox" class="box" />Ship behind, your face in front,
          selfie shot – a seafaring stunt.
        </p>
        <p id="box46">
        ...
        <p id="box49">
          <input type="checkbox" class="box" />Tender ride, bobbly blue, take a
          shot with a watery view.
        </p>
        <p id="box50">
          <input type="checkbox" class="box" />Cab it or taxi queue, capture the
          ride, urban view.
        </p>
        <p id="box51">
          <input type="checkbox" class="box" />Treasures hunted, keepsake spent,
          photo the souvenir, memory’s tent.
        </p>
        <p id="box52">
        ...
        <p id="box54">
          <input type="checkbox" class="box" />Beachside shade, umbrella’s post,
          snapshot the colors, your sun-kissed boast.
        </p>
        <p id="box55">
          <input type="checkbox" class="box" />Vendor’s cart, streetside charm,
          capture the hustle, in your palm.
        </p>
        <p id="box56">
          <input type="checkbox" class="box" />Underwater grin, a selfie’s swim,
          share that splash, on a whim.
        </p>
        <p id="box57">
        ...
        <p id="box58">
          <input type="checkbox" class="box" />Topical bird, in flight’s array,
          capture its colors, before the fly away.
        </p>
      </div>
    </div>
  </main>
